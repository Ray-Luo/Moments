...
public class TestActivity extends Activity {
	...
	GridView gridView;
	ImageBucketLevel2Adapter adapter;// 鑷畾涔夌殑閫傞厤鍣�
	AlbumHelper helper;
	Button bt;
	...
	Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			switch (msg.what) {
			case 0:
				Toast.makeText(TestActivity.this, "最多选择9张图片", Toast.LENGTH_SHORT).show();
				break;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.level2_grid);
		...
		bt.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (MyBitMap.act_bool) {
					Intent intent = new Intent(TestActivity.this, PlaceActivity.class);
					startActivity(intent);
					MyBitMap.act_bool = false;
				}
	...
	private void initView() {
		...
		adapter = new ImageBucketLevel2Adapter(TestActivity.this, dataList,
				mHandler);
